        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="navbar-brand" href="../../../html/ltr/horizontal-menu-template-dark/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text mb-0">GainReview</h2>
                    </a></li>
            </ul>
        </div>
                    ...
                    <li class="nav-item nav-search">
                        <a class="nav-link nav-link-search"><i class="ficon" data-feather="search"></i></a>
                            <div class="search-input">
                                ...
                                <input id="search_url2" class="form-control input" type="text" placeholder="Enter Shopee Product Link..." tabindex="-1" data-search="search">
