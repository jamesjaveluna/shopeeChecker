                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="profile-img-container d-flex align-items-center">
                                        <div class="profile-img">
                                            <img src="../../../app-assets/images/portrait/small/<?php echo $details->avatar; ?>" class="rounded img-fluid" alt="Card image" />
                                        </div>
                                        <!-- profile title -->
                                        <div class="profile-title ml-3">
                                            <h2 class="text-white"><?php echo $details->fullname; ?></h2>
                                            <p class="text-white">Level <?php echo $details->level; ?></p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <div class="profile-tabs d-flex justify-content-between flex-wrap mt-1 mt-md-0">
                                                <ul class="nav nav-pills mb-0">
                                                    <li class="nav-item">
                                                        <a class="nav-link font-weight-bold <?php if($page == 'overview') { echo 'active'; } ?>" href="../../profile/<?php echo $id; ?>/overview">
                                                            <span class="d-none d-md-block">Overview</span>
                                                            <i data-feather="rss" class="d-block d-md-none"></i>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link font-weight-bold <?php if($page == 'earnings') { echo 'active'; } ?>" href="../../profile/<?php echo $id; ?>/earnings">
                                                            <span class="d-none d-md-block">Earnings</span>
                                                            <i data-feather="info" class="d-block d-md-none"></i>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link font-weight-bold <?php if($page == 'achievement') { echo 'active'; } ?>" href="../../profile/<?php echo $id; ?>/achievement">
                                                            <span class="d-none d-md-block">Achievements</span>
