...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">Title</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Welcome to Title! 👋</h2>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>
                                
                                <form class="auth-login-form mt-2" id="login-form" method="POST">
                                    <div class="form-group">
                                        <label class="form-label" for="login-email">Email</label>
                                        <input class="form-control" type="text" name="email" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" name="remember" type="checkbox" tabindex="3" />
    ...
    <script src="../app-assets/js/scripts/pages/notification.js"></script>
    <!-- END: Page JS-->
	...
	$('#login-form').submit(function(e){
        ...
        document.getElementById('login').textContent = 'Signing in';
		if($(this).find('.alert').length > 0 )
			$(this).find('.alert').remove();
		$.ajax({
			url:'./api/account/login.php?op=process',
			method:'POST',
			data:$(this).serialize(),
			error:err=>{
				console.log(err)
                ...
                fetch('../app-assets/system/en/toast.json')
                            ...
                            .then(json => 
                                json.forEach(notification => {
                                        console.log(notification.id+" == "+obj.code);
                                        if (notification.id == obj.code) {
                                        $('#login-form').prepend('<div class="alert alert-'+notification.type+' mt-1 alert-validation-msg" role="alert"> <div class="alert-body"> <span>'+notification.desc.replace(/{(.*?)}/, obj.value[0])+'</span> </div> </div>');
                                        }
