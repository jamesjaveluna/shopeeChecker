...
$total_page = $shop->get_products_count();

$page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;

// Number of results to show on each page.
$num_results_on_page = $_config['shop']['limit_products'];

$number_of_page = ceil ($total_page/$num_results_on_page); 
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static <?php if(isset($_SESSION['sys']['menu_collapsed']) && $_SESSION['sys']['menu_collapsed'] == 1)  {  echo 'menu-collapsed';  }  ?>" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    include $_SERVER['DOCUMENT_ROOT'].'/app-assets/inc/header.php';
    ...
    include $_SERVER['DOCUMENT_ROOT'].'/app-assets/inc/menu.php';
    ...
    <!-- BEGIN: Content-->
     <?php
        ...
        include $_SERVER['DOCUMENT_ROOT'].'/content/shop.php';
   ...
   include $_SERVER['DOCUMENT_ROOT'].'/app-assets/inc/footer.php';
